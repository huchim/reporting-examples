...
namespace Jaguar.Reporting.WebFormsNet40
{
    public partial class DescargarReporte : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var resultado = this.reportManager.Process(new Guid(generatorId));

            // Vamos a descargarlo.
            // Ajustamos de acuerdo al tipo de archivo.
            Response.ContentType = resultado.MimeType;

            // Creamos un nombre de archivo para cuando se descargue.
            Response.AddHeader("Content-Disposition", string.Format("attachment; filename={0}", reportId));

            // Enviamos los datos y terminamos la solicitud.
            Response.OutputStream.Write(resultado.Data, 0, resultado.Data.Length);
